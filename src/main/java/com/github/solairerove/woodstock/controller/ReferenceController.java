...
@RestController
@RequestMapping(value = "/api/units/{unitId}/modules/{moduleId}/references", produces = MediaType.APPLICATION_JSON_UTF8_VALUE)
public class ReferenceController {
    ...
    public ResponseEntity create(@PathVariable String unitId, @PathVariable String moduleId, @RequestBody ReferenceDTO referenceDTO) {
...
//    }
    ...
    @RequestMapping
    public ResponseEntity getAll(@PathVariable String unitId, @PathVariable String moduleId) {
